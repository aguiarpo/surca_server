...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BlockedGuard = /** @class */ (function () {
                function BlockedGuard(constants, router, cookie, loginService) {
                    this.constants = constants;
                    this.router = router;
                    this.cookie = cookie;
                    this.loginService = loginService;
                }
                BlockedGuard.prototype.canActivate = function (next, state) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var password, email, user;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(this.constants.login === undefined)) return [3 /*break*/, 8];
                                    password = void 0;
                                    email = void 0;
                                    if (!(this.cookie.get('email') && this.cookie.get('password'))) return [3 /*break*/, 1];
                                ...
                                case 3:
                                    user = void 0;
                                    return [4 /*yield*/, this.loginService.getUser(email, password)];
                                case 4:
                                    user = _a.sent();
                                    if (!(user.levelsOfAccess === 'ADMIN')) return [3 /*break*/, 5];
                                    return [2 /*return*/, true];
                                case 5: // Verifica se é administrador
            ...
            BlockedGuard.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(router, cookie, constant) {
                    this.router = router;
                    this.cookie = cookie;
                    this.constant = constant;
                ...
                HomeComponent.prototype.get = function (text) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeRoutesModule = /** @class */ (function () {
                function HomeRoutesModule() {
                }
                return HomeRoutesModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ReportComponent = /** @class */ (function () {
                function ReportComponent(report, excelService) {
                    this.report = report;
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    this.filterString.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500))
                                        .subscribe(function () { return _this.getSuggestions(); }); // Quando o usuário fica 500ms sem digitar exceuta a função
                                    return [2 /*return*/];
                            }
                        });
                    });
                };
                ReportComponent.prototype.onKeyUp = function () {
                    this.filterString.next();
                };
                ReportComponent.prototype.getAll = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            this.createTable();
                            return [2 /*return*/];
                ...
                ReportComponent.prototype.setFocus = function (b) {
                    this.focus = b;
                };
                ReportComponent.prototype.getSuggestions = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, i;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    this.suggestions = [];
                                    _a = this;
                                    return [4 /*yield*/, this.report.getSuggestion(this.suggestionValue)];
                                case 1:
                                    _a.response = _b.sent();
                                    if (this.response) {
                                        i = void 0;
                ...
                ReportComponent.prototype.setSuggestion = function (suggestion) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                ...
                ReportComponent.prototype.createTable = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    if (!(this.suggestionValue === undefined || this.suggestionValue === '')) return [3 /*break*/, 2];
                                    _a = this;
                                    return [4 /*yield*/, this.report.getAll()];
                                case 1:
                                    _a.reportList = _c.sent();
                                    return [3 /*break*/, 4];
                                case 2:
                                    _b = this;
                                    return [4 /*yield*/, this.report.get(this.suggestionValue)];
                                case 3:
                                    _b.reportList = _c.sent();
                                    _c.label = 4;
                                case 4:
                                    this.createExcel();
                                    return [2 /*return*/];
                ...
                ReportComponent.prototype.createExcel = function () {
                    var i;
                ...
                ReportComponent.prototype.convertMapsToObjects = function (map) {
                    var e_1, _a;
                    var obj = {};
                    var prop;
                    try {
                ...
                ReportComponent.prototype.excelDownload = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _globals_service_constants_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../globals-service/constants.service */ "./src/app/globals-service/constants.service.ts");
            /* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/ngx-cookie-service.js");
            var GetReportService = /** @class */ (function () {
                function GetReportService(http, constant, cookie) {
                    this.http = http;
                    this.constant = constant;
                    this.cookie = cookie;
                }
                GetReportService.prototype.header = function () {
                    return {
                ...
                GetReportService.prototype.getAll = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/admin/animal/report', this.header()).toPromise().catch(function (err) { return _this.response = undefined; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                ...
                GetReportService.prototype.get = function (name) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.constant.progress = true;
                                    return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/admin/animal/report/' + name, this.header()).toPromise().catch(function (err) { return _this.response = undefined; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    this.constant.progress = false;
                                    return [2 /*return*/, this.response];
                ...
                GetReportService.prototype.getSuggestion = function (suggestionValue) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/admin/animal/' + suggestionValue, this.header()).toPromise().catch(function (err) { return _this.response = undefined; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/, this.response];
                            }
            ...
            GetReportService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateAndEditComponent = /** @class */ (function () {
                function CreateAndEditComponent(activatedRoute, router, crudService, constant) {
                ...
                CreateAndEditComponent.prototype.setUserValuesEmptyInputs = function () {
                    this.type = 'register';
                    this.vet = {
                        code: null,
                        crmv: null,
                ...
                Object.defineProperty(CreateAndEditComponent.prototype, "f", {
                    get: function () { return this.registerForm.controls; } // Função para os controles das validações
                    ,
                    enumerable: true,
                    configurable: true
                });
                CreateAndEditComponent.prototype.ngOnInit = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (!(this.type === 'edit')) return [3 /*break*/, 2];
                                    _a = this;
                                    return [4 /*yield*/, this.crudService.get(this.id)];
                                case 1:
                                    _a.vet = _b.sent();
                                    return [3 /*break*/, 3];
                                case 2:
                ...
                CreateAndEditComponent.prototype.validator = function () {
                ...
                CreateAndEditComponent.prototype.passwordValidate = function (control) {
                    var show;
                    var password;
                ...
                CreateAndEditComponent.prototype.crmvValidate = function (control) {
                    var crmv;
                    var user;
                ...
                CreateAndEditComponent.prototype.clickButton = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    _a = this;
                                    return [4 /*yield*/, this.crudService.edit(this.vet)];
                                case 1:
                                    _a.response = _c.sent(); // Edita o usuário
                                ...
                                case 2:
                                    _b = this;
                                    return [4 /*yield*/, this.crudService.create(this.vet)];
                                case 3:
                                    _b.response = _c.sent(); // Registra o usuário
                ...
                return CreateAndEditComponent;
            }());
            CreateAndEditComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CrudService = /** @class */ (function () {
                function CrudService(http, constant, cookie) {
                    this.http = http;
                    this.constant = constant;
                    this.cookie = cookie;
                }
                CrudService.prototype.header = function () {
                    return {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Content-Type': 'application/json',
                            'Access-Control-Allow-Origin': '*',
                ...
                CrudService.prototype.delete = function (id, column) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.constant.progress = true;
                                    if (!(column === 'removed')) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.http.delete(this.constant.baseAppUrl + 'v1/admin/usuario/visible/' + id, this.header()).toPromise().catch(function (err) { return _this.deleteStatus = false; }).then(function (data) { return _this.deleteStatus = true; })];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 4];
                                case 2: return [4 /*yield*/, this.http.delete(this.constant.baseAppUrl + 'v1/admin/usuario/' + id, this.header()).toPromise().catch(function (err) { return _this.deleteStatus = false; }).then(function (data) { return _this.deleteStatus = true; })];
                                case 3:
                                    _a.sent();
                                    _a.label = 4;
                                case 4:
                                    this.constant.progress = false;
                                    return [2 /*return*/, this.deleteStatus];
                            }
                        });
                    });
                };
                CrudService.prototype.edit = function (user) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.constant.progress = true;
                                    return [4 /*yield*/, this.http.put(this.constant.baseAppUrl + 'v1/admin/usuario/', JSON.stringify(user), this.header()).toPromise().catch(function (err) { return _this.response = err; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    this.constant.progress = false;
                                    return [2 /*return*/, this.response];
                ...
                CrudService.prototype.create = function (user) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.constant.progress = true;
                                    return [4 /*yield*/, this.http.post(this.constant.baseAppUrl + 'v1/admin/usuario/', JSON.stringify(user), this.header()).toPromise().catch(function (err) { return _this.response = err; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    this.constant.progress = false;
                                    return [2 /*return*/, this.response];
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.constant.progress = true;
                                    return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/admin/usuario/' + id, this.header()).toPromise().catch(function (err) { return _this.response = undefined; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    this.constant.progress = false;
                                    return [2 /*return*/, this.response];
                ...
                CrudService.prototype.getAll = function (column, value, page) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.constant.progress = true;
                                    return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/admin/usuario/' + column + '/' + value + '?page=' + page, this.header()).toPromise().catch(function (err) { return _this.response = undefined; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    this.constant.progress = false;
                                    return [2 /*return*/, this.response];
                ...
                CrudService.prototype.getSuggestion = function (column, value) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/admin/usuario/like/' + column + '/' + value, this.header()).toPromise().catch(function (err) { return _this.response = undefined; }).then(function (data) { return _this.response = data; })];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/, this.response];
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GetComponent = /** @class */ (function () {
                function GetComponent(crudService, router, constant) {
                    this.crudService = crudService;
                    this.router = router;
                    this.constant = constant;
                    this.page = 1;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    this.filterString.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500))
                                        .subscribe(function () { return _this.getSuggestions(); }); // Após 500ms sem o usuário digitar executa a função
                                    return [2 /*return*/];
                            }
                        });
                    });
                };
                GetComponent.prototype.getSuggestions = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, i;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    this.suggestions = [];
                                    _a = this;
                                    return [4 /*yield*/, this.crudService.getSuggestion(this.select, this.suggestionValue)];
                                case 1:
                                    _a.response = _b.sent();
                                    if (this.response) {
                                        i = void 0;
                ...
                GetComponent.prototype.createTable = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, search, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    if (!(this.suggestionValue === undefined)) return [3 /*break*/, 2];
                                    _a = this;
                                    return [4 /*yield*/, this.crudService.getAll(this.select, 'empty', this.page - 1)];
                                case 1:
                                    _a.users = _c.sent();
                                    return [3 /*break*/, 4];
                                case 2:
                                    ...
                                    _b = this;
                                    return [4 /*yield*/, this.crudService.getAll(this.select, search, this.page - 1)];
                                case 3:
                                    _b.users = _c.sent();
                                    _c.label = 4;
                                case 4:
                ...
                GetComponent.prototype.setTotalPage = function () {
                    this.pages = [];
                    var i;
                    if (this.users) {
                ...
                GetComponent.prototype.setPage = function (value) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                ...
                GetComponent.prototype.delete = function (code) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.crudService.delete(code, this.select)];
                                case 1:
                                    if (_a.sent()) { // Deleta o usuário no banco de dados
                                        this.users.content.forEach(function (value, index) {
                                            // tslint:disable-next-line:triple-equals
                                            if (value.code == code) {
                                                _this.users.content.splice(index, 1); // Remove o usuário na lista sem atualizar a página
                                            }
                                        });
                                    }
                                    return [2 /*return*/];
                ...
                GetComponent.prototype.ngAfterViewInit = function () {
                    // @ts-ignore
                    $('select').formSelect();
                };
                GetComponent.prototype.setFocus = function (b) {
                    this.focus = b;
                };
                GetComponent.prototype.setSuggestion = function (suggestion) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                ...
                GetComponent.prototype.onKeyUp = function () {
                    this.filterString.next();
                };
                GetComponent.prototype.getAll = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            this.page = 1;
                            this.createTable();
                ...
                GetComponent.prototype.changePlaceholder = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (this.select) {
                                case 'name':
                ...
                GetComponent.prototype.navigation = function (s) {
                    this.constant.progress = true;
                    this.router.navigate([s]);
                };
                GetComponent.prototype.getById = function (code) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = this;
                                    return [4 /*yield*/, this.crudService.get(code)];
                                case 1:
                                    _a.vet = _b.sent();
                                    if (this.vet) {
                                        this.showModal = true;
                ...
                GetComponent.prototype.setShowModal = function (b) {
                    this.showModal = b;
                };
                return GetComponent;
            }());
            GetComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(loginService, router, constant, cookie) {
                    this.loginService = loginService;
                    this.router = router;
                    this.constant = constant;
                    this.cookie = cookie;
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = this;
                                    return [4 /*yield*/, this.loginService.getUser(this.email, this.password)];
                                case 1:
                                    _a.user = _b.sent();
                ...
                LoginComponent.prototype.navigation = function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    // @ts-ignore
                                    _a = this;
                                    return [4 /*yield*/, this.loginService.createAdmin()];
                                case 1:
                                    // @ts-ignore
                                    _a.admin = _b.sent();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginService = /** @class */ (function () {
                ...
                LoginService.prototype.getUser = function (email, password) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var httpOptions;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/user/usuario/login', httpOptions).toPromise().catch(function (err) {
                ...
                LoginService.prototype.createAdmin = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var httpOptions;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.http.get(this.constant.baseAppUrl + 'v1/create/admin', httpOptions).toPromise().catch(function (err) {
                                            _this.user = undefined;
                                        }).then(function (data) {
                                            _this.user = data;
                                        })];
